...
namespace TechnicalSchool.Controllers
{
    public class EstudantesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Sobrenome,Nome,DataInscricao")] Estudante estudante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Sobrenome,Nome,DataInscricao")] Estudante estudante)
        {
            if (ModelState.IsValid)
            {
